  ...
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700'>
      ...
      <div>
        ...
        <p className='marcellus-regular font-semibold'>Authenticity Guarantee</p>
      ...
      <div>
        ...
        <p className='marcellus-regular font-bold'>Secure Payment</p>
      ...
      <div>
        ...
        <p className='marcellus-regular font-semibold'>Fast Shipping</p>
