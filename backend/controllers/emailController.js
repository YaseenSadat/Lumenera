 ...
 * emailController.js
 * 
 * This controller handles email-related functionalities for the application.
 * It includes:
 * - Sending purchase confirmation emails.
 * - Sending subscription welcome emails.
 * - Sending password reset emails with secure tokens.
 */

import { sendEmail } from '../config/emailService.js'; // Utility for sending emails
import crypto from 'crypto'; // For generating secure tokens
import User from '../models/userModel.js'; // User model for interacting with the database
...
/**
 * Sends a subscription welcome email to the user.
 * 
